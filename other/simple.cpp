...
float m = 3.0, g = 9.8, r = 2.0, I = 12.0, h = 0.0166666, l = 2.0;
...
void pause(float dur) {
    ...
    for (;(current-start).count() < (unsigned long long)(dur*std::pow(10,9));current = std::chrono::high_resolution_clock::now()) {}
}
